...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"API_URL":"http://localhost/","API_URL_BROWSER":"https://api.calibur.tv/","META_KEYS":"C站,calibur,咔哩吧,ACG,二次元,社区","META_DESC":"咔哩吧是一个二次元社区","SOCKET_HOST":"wss://api.calibur.tv/ws"}
    }
    // Only set once
    if (context.req) {
