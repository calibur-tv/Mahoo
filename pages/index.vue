...
<template>
  <div id="page-index">
      ...
      <el-carousel :autoplay="false">
        <el-carousel-item :key="0">
          <div class="mahoo">
            ...
            <div class="desc">
              <p>组件名称：魔法</p>
              <p>交互模式：电脑端鼠标滑动页面展示效果，手机端滑动屏幕展示效果</p>
              <p>商品信息：该组件基于 WebGL 开发而成，支持电脑端和手机端，可用于游戏效果展示</p>
              <p>交付方式：该商品是二进制代码，交易前不支持测试，交易后不支持退款，请在本页面进行效果预览</p>
              <p>授权价格：100￥</p>
              <p>授权周期：永久有效，并提供后续优化支持</p>
              <p>PS：由于站内虚拟支付尚未开通，请加入技术交流QQ群：106402736 进行交易</p>
            </div>
          </div>
        </el-carousel-item>
        <el-carousel-item :key="1">
          <div class="solar-syst-wrap">
            ...
            <div class="desc">
              <p>组件名称：太阳系</p>
              <p>交互模式：无需操作，动画自动执行</p>
              <p>商品信息：该组件基于 CSS3 开发而成，支持电脑端和手机端，可用于APP开屏效果展示</p>
              <p>交付方式：该商品是二进制代码，交易前不支持测试，交易后不支持退款，请在本页面进行效果预览</p>
              <p>授权价格：80￥</p>
              <p>授权周期：永久有效，并提供后续优化支持</p>
              <p>PS：由于站内虚拟支付尚未开通，请加入技术交流QQ群：106402736 进行交易</p>
    ...
    <div class="footer">
      <div class="intro">
        <br>
        calibur.tv 为游戏开发者提供专业级的特效技术支持
        <br>
        我们会在网站上定期公布付费模块，支持线上支付购买代码（支付渠道开通中）
        <br>
        并在技术交流群中定期发布免费模块，欢迎游戏开发者加入（QQ群：106402736）
        <br>
        更多专业级动画特效敬请期待
      </div>
